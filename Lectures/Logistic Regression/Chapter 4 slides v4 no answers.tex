...
\begin{frame}{\textcolor{violet}{Pollev:} Interaction/effect modification example}
	...
	\begin{itemize}
		\item Odds of getting a result among those who \textbf{don't} get and incentive and are \textbf{50 or younger}: %\pause  \textcolor{blue}{$e^{\beta_0}$}
		
		\medskip
		
		\item Odds of getting a result among those who \textbf{don't} get and incentive and are \textbf{older than 50}: %\pause  \textcolor{blue}{$e^{(\beta_0+\beta_2)}$}
		
		\medskip
		
		\item Odds of getting a result among those who \textbf{do} get and incentive and are \textbf{50 or younger}: %\pause  \textcolor{blue}{$e^{(\beta_0+\beta_1)}$}
		
		\medskip
		
		\item Odds of getting a result among those who \textbf{do} get and incentive and are \textbf{older than 50}: %\pause  \textcolor{blue}{$e^{(\beta_0+\beta_1 + \beta_2 +\beta_3)}$}
...
\begin{frame}{\textcolor{violet}{Pollev:} Interaction/effect modification example}
	...
	\begin{itemize}
		\item Odds ratio of getting a result \textbf{comparing those who do and do not} get an incentive and are \textbf{50 or younger}: %\pause  \textcolor{blue}{$e^{\beta_1}$}
		
		\medskip
		
		\item Odds ratio of getting a result \textbf{comparing those are older than 50 and those who are at most 50} and \textbf{don't get an incentive}: %\pause  \textcolor{blue}{$e^{\beta_2}$}
		
		\medskip
		
		\item Odds ratio of getting a result \textbf{comparing those who do and do not} get an incentive and are \textbf{older than 50}: %\pause  \textcolor{blue}{$e^{\beta_1+\beta_3}$}
		
		\medskip
		
		\item Odds ratio of getting a result \textbf{comparing those older than 50 and those who are at most 50} and \textbf{get an incentive}: %\pause  \textcolor{blue}{$e^{\beta_2+\beta_3}$}
...
\begin{frame}{\textcolor{violet}{Pollev:} Adjustment Variable Review}
	...
	Should we adjust for age? %\pause \textcolor{blue}{Yes, it is a potential confounder.}
	
	\medskip
	
	Should we adjust for distance? %\pause \textcolor{blue}{No, precision variables no longer exist for logistic regression.}
