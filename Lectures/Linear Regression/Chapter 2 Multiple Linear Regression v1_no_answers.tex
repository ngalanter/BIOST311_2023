...
\begin{figure}
	\centering \includegraphics[scale=0.5]{anova_race.png}
\end{figure}
...
\begin{figure}
	\centering \includegraphics[scale=0.5]{anova_race2.png}
\end{figure}
...
\includegraphics[scale=0.01]{technical} The p-value here corresponds to an F statistic, as opposed to a $t$ statistic as with hypothesis tests for single coefficients (e.g., $\beta_1 = 0$ vs. $\beta_1 \neq 0$). The key here is that F tests allow us to test for multiple coefficients being equal to $0$ at once.
...
\begin{frame}{Linear regression with a categorical predictor in \texttt{R}}
	...
	\begin{figure}
		\centering \includegraphics[scale=0.35]{anova_race3.png}
	\end{figure}
...
\begin{frame}{\textcolor{violet}{Pollev}}
	Suppose I had a variable called location, which had levels of "Seattle", "Snoqualmie", "Redmond", and "Other". If I want to test whether location is associated with birth-weight, how many degrees of freedom will the test be? %\pause
