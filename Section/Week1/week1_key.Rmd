...
## load the FEV data
setwd("C:/Users/ninag/Documents/GitHub/BIOST311_2023/Datasets")
...
In the R code box below, get a summary of the data just for those births that were preterm, using the `preterm` variable created previously.

```{r activity}

preterm_births <- births %>% filter(preterm == 1)

summary(preterm_births)
