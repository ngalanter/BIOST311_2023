...
\vspace{0.2cm}
Should we throw out these incompletely observed times?    \textcolor{red}{This is a bad idea!} 
...
What does that mean?   \textit{Individuals who are censored at time $t$ must be \textbf{similar} to those remaining in the risk set after time $t$.}  
\\ ~\ 
...
\end{align*}  
\begin{itemize}
\item \textcolor{blue}{$h(t) = $ instantaneous event rate at $t$}  
